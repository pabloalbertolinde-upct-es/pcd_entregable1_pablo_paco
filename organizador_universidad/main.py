...
class Universidad:
    ...
    def add_alumno(self, dni, nombre, direccion, sexo):
        """Añade un nuevo alumno a la lista de alumnos de la universidad y lo devuelve."""
    ...
    def add_profesor(self, dni, nombre, direccion, sexo, dep, area=None):
        """Añade un nuevo profesor o investigador a la lista de profesores de la universidad y lo devuelve."""
        if area is None:
    ...
    def add_asignatura(self, nombre, creditos=6):
        """Añade una nueva asignatura a la lista de asignaturas de la universidad y la devuelve."""
    ...
    def add_departamentos(self):
        """Añade los departamentos predeterminados a la lista de departamentos de la universidad y los devuelve."""
    ...
    def borrar(self, persona):
        """Elimina una persona de la universidad."""
    ...
    def mostrar_departametos(self):
        """Muestra los nombres de los departamentos de la universidad."""
