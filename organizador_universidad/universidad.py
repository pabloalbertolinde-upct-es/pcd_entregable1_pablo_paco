...
imanuel = upct.add_profesor("dnimanue", "manuel", "calle manue", "macho", dep2, "señales")
manuel = upct.add_profesor("dnimanue", "manuel", "calle manue", "macho", dep2)
...
print(dep2)
print(dep1)
upct.cambiar_profesor_dep(pisabel, dep3)
print()
upct.cambiar_investigador_area(imanuel, dep3)
print(pisabel)
print(dep2)
